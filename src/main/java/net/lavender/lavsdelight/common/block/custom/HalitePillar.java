...
public class HalitePillar extends PillarBlock {
    public final IntProvider xpRange;
    public HalitePillar(BlockBehaviour.Properties pProperties) {
        this(pProperties, UniformInt.of(1, 3));
    }
    public HalitePillar(BlockBehaviour.Properties pProperties, IntProvider pXpRange) {
        super(pProperties);
